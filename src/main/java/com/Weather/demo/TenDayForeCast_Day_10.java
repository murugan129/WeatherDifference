...
public class TenDayForeCast_Day_10
{
    ...
    {	
    	...
    	intTempHigh = Integer.parseInt(JsonPath.read(body, "$.forecast.simpleforecast.forecastday[9].high.fahrenheit").toString());
    	intTempLow = Integer.parseInt(JsonPath.read(body, "$.forecast.simpleforecast.forecastday[9].low.fahrenheit").toString());
    	    	
    	strDate = JsonPath.read(body, "$.forecast.simpleforecast.forecastday[9].date.pretty").toString();
